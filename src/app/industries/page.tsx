...
const industries = [{
  ...
  items: ['Профилактические и истребительные мероприятия по утверждённым регламентам'],
}, {
  icon: Building2,
  ...
  items: ['Комплексная обработка офисов', 'Уничтожение клопов, тараканов, блох', 'Гарантия результата'],
}, {
  icon: Factory,
  title: 'Производственные объекты',
  items: ['Обработка складских помещений', 'Дератизация территорий', 'Мониторинг'],
}];
