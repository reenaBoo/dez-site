...
const industries = [{
  ...
  icon: Home, title: 'Жилые помещения', items: ['Комплексная обработка квартир и домов', 'Уничтожение клопов, тараканов, блох', 'Гарантия результата до 3 лет'],
}, {
  icon: Factory, title: 'Производственные объекты', items: ['Обработка складских помещений', 'Дератизация территорий', 'Регулярный мониторинг'],
}];
