export const theme = {
  colors: {
    primary: '#FDB913', primaryDark: '#E5A50B', primaryLight: '#FFCA3A',

    background: '#03060D', backgroundAlt: '#0A1018', navy: '#03060D', navyLight: '#0F1824', navyDark: '#000000',

    secondary: '#1E3A8A',

    // Текст
    text: '#E5E7EB', textLight: '#9CA3AF', heading: '#FFFFFF',

    border: '#1E3A8A', error: '#EF4444', success: '#10B981', warning: '#FDB913',
  },
